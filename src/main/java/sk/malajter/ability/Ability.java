...
public enum Ability {
    ...
    DEXTERITY("Dexterity is important for both attack and defence. It affect final damage and final damage reduction."),
    SKILL("Skill is important for attack and also for critical hit chance."),
    LUCK("Luck is important for critical hit chance."),
    HEALTH("Health is the amount of damage you can take before you die. After each battle health can be restore to full.");
